# -*- coding: utf-8 -*-
"""
Created on Wed Oct 23 10:43:10 2019
...
train_X, train_Y = data_encode("training_set.txt") #dataset de treinamento
test_X, test_Y = data_encode("testing_set.txt") #dataset de validacao
